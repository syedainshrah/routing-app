            ...
            <div className="relative flex justify-between items-center py-4 px-4 sm:px-12 md:px-16 max-w-7xl mx-auto">
                ...
                {isMenuOpen && (
                    <div className="md:hidden absolute top-full left-0 w-full bg-yellow-200 flex flex-col items-center space-y-4 py-6 shadow-lg">
                        <Link href="/" className="text-black hover:text-gray-300" onClick={toggleMenu}>Home</Link>
                        <Link href="/pages/shop" className="text-black hover:text-gray-700" onClick={toggleMenu}>Shop</Link>
                        <Link href="/About" className="hover:text-gray-700 text-black " onClick={toggleMenu}>About</Link>
                        <Link href="/pages/contact" className="hover:text-gray-700 text-black" onClick={toggleMenu}>Contact</Link>
                    </div>
                )}
                ...
                <div className="hidden md:flex justify-center items-center gap-8 lg:gap-16 flex-grow">
                    ...
                    <Link href="/pages/shop" className="text-black hover:text-gray-700">Shop</Link>
                    <Link href="/About" className="hover:text-gray-700 text-black">About</Link>
                    <Link href="/pages/contact" className="hover:text-gray-700 text-black">Contact</Link>
                </div>
