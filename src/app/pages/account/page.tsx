  ...
  return (
    <div className='bg-white'>
      ...
      <div className="relative">
        ...
        {/* Background Image wrapped in a Card */}
        <div className="absolute top-0 left-0 w-full h-[50vh] sm:h-[60vh] md:h-[70vh] bg-white shadow-lg rounded-lg overflow-hidden">
          <Image
            src="/rect.png"
            alt="Background"
            layout="fill"
        ...
        {/* House Icon wrapped in a Card */}
        <div className="absolute top-16 sm:top-24 md:top-28 left-1/2 transform -translate-x-1/2 bg-white shadow-lg rounded-full p-2">
          <Image
            src="/house.png"
            alt="House Icon"
            width={80}
